<template>
  <view class="page_customer_users diy_table diy_table_tml" id="customer_users_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/customer_users/view?" v-show="user_group == '管理员' || $check_action('/customer_users/table','add') || $check_action('/customer_users/view','add')">添加</navigator>
                            ...
                            <span>用户姓名</span>
								...
								<text>
									{{ o["user_name"] }}
													...
													<view v-if="0 && $check_field('get','user_gender')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>用户性别</span>
                          </view>
								...
								<text>
									{{ o["user_gender"] }}
													...
													<view v-if="0 && $check_field('get','user_age')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>用户年龄</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/customer_users/table','del') || $check_action('/customer_users/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/customer_users/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/customer_users/table','set') || $check_action('/customer_users/view','set') || $check_action('/customer_users/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
