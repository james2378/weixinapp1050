<template>
  <view id="home" class="home--new">
    ...
    <Card
      class="list_diy"
      title="房间信息推荐"
      url="/pages/room_information/list"
      :list="list_article"
      v-if="$check_action('/room_information/list', 'get')"
    >
	  <list_room_information :list="list_room_information"></list_room_information>
...
<script>
					...
					import list_room_information from "@/components/diy/list_room_information.vue";
      ...
      this.isAdmin = !this.isAdmin;
		...
		*/
		get_room_information() {
			let url = "~/api/room_information/get_list?";
															url = "~/api/room_information/get_list?orderby=hits desc";
										
			this.$get(url, {
											}, (json) => {
					if (json.result && json.result.list) {
					console.log("房间信息" ,json.result.list);
					this.list_room_information = json.result.list;
											this.list_room_information.map((o)=>{
							o["praise_len"];
						});
						this.get_praise(this.list_room_information ,"room_information" ,"34188");
									}
			});
		},
