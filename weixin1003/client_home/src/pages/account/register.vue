						...
						<view class="register_view">
							<uni-forms class="form_register" :rules="rules" :value="form" ref="form"
								...
								<uni-forms-item class="user_group" name="user_group" label="身份">
									...
									<!-- 顾客用户 -->
								<form_customer_users v-if="form.user_group === '顾客用户'" @change="handleSubFormChange" :form="form_sub" ></form_customer_users>
...
<script>
	import mixin from "@/libs/mixins/page.js"
		/* 顾客用户 */
	import form_customer_users from "@/components/diy/form_customer_users";
