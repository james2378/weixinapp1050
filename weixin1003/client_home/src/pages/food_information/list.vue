<template>
	<view class="page_food_information diy_list diy_list_page div_list_tml" id="food_information_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索备注信息" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'remarks')">
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?food_information_id=' + o['food_information_id']" class="btn btn-primary">查看详情</navigator>
