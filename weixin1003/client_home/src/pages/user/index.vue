					...
					<view>
						<view class="">
							<view  class="list_module">
									<view v-if="user_group != '管理员' && $check_action('/customer_users/table','get')">
									<navigator class="my_module" url="/pages/customer_users/table" hover-class="hover">
										<div>
											<text>顾客用户</text>
											<span>></span>
										</div>
											...
											<view v-if="user_group != '管理员' && $check_action('/food_orders/table','get')">
									<navigator class="my_module" url="/pages/food_orders/table" hover-class="hover">
										<div>
											<text>食物订单</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/room_information/table','get')">
									<navigator class="my_module" url="/pages/room_information/table" hover-class="hover">
										<div>
											<text>房间信息</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/room_orders/table','get')">
									<navigator class="my_module" url="/pages/room_orders/table" hover-class="hover">
										<div>
											<text>房间订单</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/room_type_management/table','get')">
									<navigator class="my_module" url="/pages/room_type_management/table" hover-class="hover">
										<div>
											<text>房型管理</text>
											<span>></span>
										</div>
